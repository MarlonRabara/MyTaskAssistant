...
- **Terminal synchronization** — setting progress to 100% automatically sets Status to Completed; setting Status to Completed or Closed sets progress to 100%. Saving prevents inconsistent terminal state values.
