...
## Project Guidelines
- In MyTaskAssistant repo: update MyTaskAssistant.html, specs/MyTaskAssistant_Specification.md, ReadMe.html, and ReadMe.md in place without creating version-suffixed filename copies (files are under source control); version numbers inside document contents may still be incremented. Keep the visible HTML application version synchronized with the specification version.
